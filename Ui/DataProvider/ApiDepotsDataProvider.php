...
use Dragonfly\NovaposhtaBasic\Query\ApiDepots\GetListQuery;
 ...
 */
class ApiDepotsDataProvider extends DataProvider
{
    /**
     * @var GetListQuery
     */
    ...
    public function getSearchResult()
    {
        ...
        return $this->searchResultFactory->create(
            ...
            $searchCriteria,
            ApiDepotsInterface::API_DEPOTS_ID
        );
    }
    ...
    public function getData(): array
    {
        ...
        foreach ($this->loadedData['items'] as $item) {
            $itemsById[(int)$item[ApiDepotsInterface::API_DEPOTS_ID]] = $item;
        }

        if ($id = $this->request->getParam(ApiDepotsInterface::API_DEPOTS_ID)) {
