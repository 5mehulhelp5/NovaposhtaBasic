...
use Dragonfly\NovaposhtaBasic\Query\ApiUserList\GetListQuery;
 ...
 */
class ApiUserListDataProvider extends DataProvider
{
    /**
     * @var GetListQuery
     */
    ...
    public function getSearchResult()
    {
        ...
        return $this->searchResultFactory->create(
            ...
            $searchCriteria,
            ApiUserListInterface::API_USER_LIST_ID
        );
    }
    ...
    public function getData(): array
    {
        ...
        foreach ($this->loadedData['items'] as $item) {
            $itemsById[(int)$item[ApiUserListInterface::API_USER_LIST_ID]] = $item;
        }

        if ($id = $this->request->getParam(ApiUserListInterface::API_USER_LIST_ID)) {
