 ...
 */
class ApiCityBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'ApiCity';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'api_novaposhta_city/apicity/edit';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[ApiCityInterface::API_CITY_ID])) {
                    $urlData = [ApiCityInterface::API_CITY_ID => $item[ApiCityInterface::API_CITY_ID]];
